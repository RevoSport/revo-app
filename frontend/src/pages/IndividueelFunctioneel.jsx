  ...
  return (
    ...
    >
      ...
      >
        <MultiTestCard
          label="Drop Jump"
          tests={["Drop Jump 2-been Hoogte", "Drop Jump 1-been Hoogte", "Drop Jump 1-been RSI"]}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          <MultiTestCard
            ...
            groupedData={groupedData}
          />
          <MeanSplitCard label="Squat Forceplate – %" data={groupedData["Squat Forceplate"]} />
        </div>
      </div>
      ...
      >
        ...
        <MiniHopChart title="Single Hop Distance" data={groupedData["Single Hop Distance"]} />
        <MiniHopChart title="Side Hop" data={groupedData["Side Hop"]} />
        <HopClusterOverviewCard data={cleanData.find((f) => f.fase === "Maand 6")?.hop_cluster} />
      </div>
    </div>
  );
}
