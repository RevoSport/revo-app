...
export default function FormMaand6() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatusMsg({ type: "success", msg: "✅ Maand 6 succesvol opgeslagen" });
    ...
    >
      ...
      <form onSubmit={handleSubmit}>
        ...
        <FormField
          label="LSI (%)"
          name="dropjump_lsi"
          value={formData.dropjump_lsi}
          onChange={handleChange}
        />
        <TwoColumnFields
          leftLabel="Steunname landing (L)"
          rightLabel="Steunname landing (R)"
